...
_reg.register_is_stateful("argmax", False)
_reg.register_schedule("argmin", _schedule_reduce)
_reg.register_is_stateful("argmin", False)
_reg.register_schedule("sum", _schedule_reduce)
_reg.register_is_stateful("sum", False)
_reg.register_dynamic_compute("sum", True)
_reg.register_shape_func("sum", False, _reg.return_scalar_shape_func)
_reg.register_schedule("all", _schedule_reduce)
_reg.register_is_stateful("all", False)
_reg.register_schedule("max", _schedule_reduce)
_reg.register_is_stateful("max", False)
_reg.register_schedule("min", _schedule_reduce)
_reg.register_is_stateful("min", False)
_reg.register_schedule("prod", _schedule_reduce)
_reg.register_is_stateful("prod", False)
_reg.register_schedule("mean", _schedule_reduce)
_reg.register_is_stateful("mean", False)
_reg.register_schedule("variance", _schedule_reduce)
_reg.register_is_stateful("variance", False)
_reg.register_schedule("nn.cross_entropy", _schedule_reduce)
_reg.register_is_stateful("nn.cross_entropy", False)
_reg.register_schedule("nn.cross_entropy_with_logits", _schedule_reduce)
_reg.register_is_stateful("nn.cross_entropy_with_logits", False)
